                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus name="agency_list" id="agency_list"
                                                    ...
                                                    @foreach ($agencies as $agency)
                                                        <option
                                                            {{ (old('agency_list')==$agency->id) ? 'selected' : "" }} value="{{ $agency->id }}">{{ $agency->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <!-- <input type="text" value="{{ old('courier_company') }}"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="payment_method" class="form-control" id="">
                                                        <option
                                                            {{ (old('payment_method')=='cash_payment') ? 'selected' : "" }} value="cash_payment">
                                                            Cash Payment
                                                        </option>
                                                        <option
                                                            {{ (old('payment_method')=='paypal') ? 'selected' : "" }} value="paypal">
                                                            Paypal
                                                        </option>
                                                        <option
                                                            {{ (old('payment_method')=='stripe') ? 'selected' : "" }} value="stripe">
                                                            Stripe
                                                        </option>
                                                        <option
                                                            {{ (old('payment_method')=='paystack') ? 'selected' : "" }} value="paystack">
                                                            Paystack
                                                        </option>
                                                        <option
                                                            {{ (old('payment_method')=='credit') ? 'selected' : "" }} value="credit">
                                                            Credit
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('number_of_pcs') }}" type="number"
                                                           name="number_of_pcs"
                                                           class="form-control" id="number_of_pcs1" min="1" max="10">
                                                </div>
                                            </div> -->
