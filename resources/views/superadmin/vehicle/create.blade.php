                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="driver_mobile" value="{{old('driver_mobile')}}" class="form-control"
                                                    id="propertyname" required
                                                    placeholder="Enter Driver Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="reg_expiry" value="{{old('reg_expiry')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="next_passing" value="{{old('next_passing')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="sticker_permission_expiry" value="{{old('sticker_permission_expiry')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="insurance_expiry" value="{{old('insurance_expiry')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="traffic_no" value="{{old('traffic_no')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="gps_permit_expiry" value="{{old('gps_permit_expiry')}}" class="form-control"
                                                    id="propertyname" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <option value="vehicle_cancel">Vehicle Cancel</option>
                                                <option value="upto_date">Up to date</option>
                                                <option value="expire_nearby">Expire near by</option>                                               
                                            </select>                                                
                                            </div>
                                        </div> 
