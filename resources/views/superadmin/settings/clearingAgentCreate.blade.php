                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Clearing Agent Create </h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <form action="{{route('super-admin.clearingAgent.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="text-center"> 
                                    ...
                                    <a href="{{url('super-admin/clearingAgent')}}" type="button"
