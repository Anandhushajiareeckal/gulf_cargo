                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <div class="fa-pull-right pb-3"><a href="{{route('super-admin.visaType.create')}}"
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable"
                                ...
                                <tr>
                                    ...
                                    <form action="{{route('super-admin.visaType.delete')}}" method="post">                                  
                                    <td> 
                                    <a href="{{route('super-admin.visaType.edit',$type->id)}}" class="btn btn-icon waves-effect waves-light btn-warning">
