                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <div class="fa-pull-right pb-3"><a href="{{route('super-admin.shipmentType.create')}}"
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable"
                                ...
                                <tr>
                                    ...
                                    <form action="{{route('super-admin.shipmentType.delete')}}" method="post">                                  
                                    <td> 
                                        <a href="{{route('super-admin.shipmentType.edit',$type->id)}}" class="btn btn-icon waves-effect waves-light btn-warning">
