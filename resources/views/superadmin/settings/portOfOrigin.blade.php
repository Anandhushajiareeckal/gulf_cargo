                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <div class="fa-pull-right pb-3"><a href="{{route('super-admin.portOfOrigin.create')}}"
                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable"
                                ...
                                <tr>
                                    ...
                                    <td> 
                                    <a href="{{route('super-admin.portOfOrigin.edit',$type->id)}}" class="btn btn-icon waves-effect waves-light btn-warning">
