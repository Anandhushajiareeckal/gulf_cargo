        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <form action="{{ update_url($product->id) }}" method="post" enctype="multipart/form-data">
                                @csrf 
                                @method('PUT')
                                <div class="row">
                                        <div class="col-lg-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="branch_id" required>
                                                    ...
                                                    @foreach($branches as $branch)
                                                        <option value="{{$branch->id}}" @if($branch->id == $product->branch_id) selected @endif>{{$branch->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row"> 
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="closing_stock" value="{{$product->closing_stock}}" class="form-control"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="unit_rate" value="{{$product->unit_rate}}" class="form-control"
                                            ...
                                            <div class="body" id="boxDimension1">
                                                ...
                                                <div class="row">                                        
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            <label>Length</label>
                                                            <input type="text" name="length" value="{{$product->length}}" class="form-control box-length">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            <label>Width</label>
                                                            <input type="text" name="width" value="{{$product->width}}" class="form-control box-width">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            <label>Height</label>
                                                            <input type="text" name="height" value="{{$product->height}}" class="form-control box-height">
                                                        </div>
                                                    </div>
