        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <form action="{{ update_url($driver->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                                @csrf
                                <div class="row">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value="{{ $driver->user->email }}" class="form-control"
                                                    id="email" required
                                ...
                                <div class="row"> 
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" value="{{ $driver->mobile }}" class="form-control"
                                                    id="mobile" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="vehicle_number" value="{{ $driver->vehicle_number}}" class="form-control"
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="3" class="form-control" name="location" id="location" placeholder="Location"> {{ $driver->location}}</textarea>
