                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="table1" class="table center-aligned-table">
                                        ...
                                        foreach( $ship_bookingsList as $index=>$booking) {
                                            ...
                                            ?>
                                             <?php
                                             $count_of_pc = $ship_bookingsList->where('shipment.booking_number', $booking->shipment->booking_number )->count();
                                             ?>
                                                <tr style="{{ $style }}">
                                                    <td style="text-align:center">{{$index+1}}</td>
                                                    <td style="text-align:center">{{$booking->box_name}}</td>
                                                    {{-- <td style="text-align:center">{{$count_of_pc}}</td> --}}
