...
<?php
   $style = ""; 
            ...
            if( $attendance->clock_in != '' &&  $attendance->clock_out !=''){
                ...
                $clkin_time = strtotime(date("h:i A",  $attendance->clock_in ));

                if(  $clkin_time <= strtotime($attend_time->checkin_to) ) {  
                ...
                } else if(  $clkin_time > strtotime($attend_time->checkin_to)) {
                    
                    $diff =  $clkin_time - strtotime( $attend_time->checkin_to  );
...
$('#datatable_attandence').DataTable( {
    ...
    buttons: [
            ...
            {
                extend: 'excel',
                messageTop: 'Branch: <?=branch()->name ?>  Attendence between <?=$date_from?>  and <?=$date?>.',
                exportOptions: {
                        columns: [0,1,2,3,4,5,6,7]
