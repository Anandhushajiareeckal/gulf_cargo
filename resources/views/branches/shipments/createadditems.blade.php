                            ...
                            <form action="{{route('branch.shipment.additemsstore')}}"  id="additemsstore" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $shipment->number_of_pcs }}" type="text"
                                                           name="number_of_pcs"
                                                           class="form-control" id="number_of_pcs" min="1" max="10" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    <div style="display:none;" >
                                        <div id="boxContainer" class="boxcount">
                                            ...
                                            <div class="package col-md-12"  id="package_ID" >
                                                <div class="header">
                                                    ...
                                                    <button type="button" id="addpackage" class="btn btn-success addpackage">Add
                                                            Items
                                                        </button> 
                                                    </div> 
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">  
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name='dimension' data-no='' class='form-control box-dimension' onchange="getval(this);">
                                                    ...
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="unit_value" value="" class="form-control box-unit-value">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            <label>Weight</label>
                                                            <input type="text" name="weight" value="{{ $weight->weight?$weight->weight:''}}" class="form-control box-weight">
                                                        </div>
                                                    </div>                                                   
                                                    <div class="col-md-2">  
                                                        <div class="form-group">
                                                            <label>Total Value</label>
                                                            <input type="text" name="total_value" value="" class="form-control box-total-value total" readonly>
                                                        </div>
                                                    </div>                                                    
                                                </div>
                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="60%">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">  
                                                                    <div class="">
                                                                        <input type="text" name="msic_weight" value="" class="form-control msic_weight">
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    ...
                                                    <td width="40%">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">  
                                                                    <div class="">
                                                                        <input type="text" name="additional_packing_charge" value="" class="form-control total">
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="body" id="boxDimension1">
                                        ...
                                        <div class="row">                                        
                                            ...
                                            <div class="col-md-2">  
                                                <div class="form-group">
                                                    <label>Weight</label>
                                                    <input type="text" name="weight" value="" class="form-control box-weight">
                                                </div>
                                            </div>
                                            <div class="col-md-2">  
                                                <div class="form-group">
...
@section('scripts')
        ...
        $(function () {  
            ...
            $('#addBox').on('click', function () { 
                ...
                if( no_of_box == 0 ){  
                    ...
                    $("input[name='document_charge']").val('');
               ...
               count += 1;
                ...
                // $('#Container').html('');
                for (i = 0; i < 1; i++) {
                       var myClone =  $('#boxContainer').clone().attr('id', 'boxContainer'+ count);
                        ...
                        myClone.find('.packageinfo-head').text( 'Package Info ' + j +' Box '+ '<?=branch()->branch_code?branch()->branch_code:''?>' + j+<?=$bookingNum?>);
                        ...
                        myClone.find('div #packageinfo').attr('id', 'packageinfo'+j);
            ...
            $(document).on("click", ".addpackage", function (event) {     
                ...
                var html = `<tr>
                            <td style="padding:10px" width="40%"><input placeholder="Enter description" type="text" name="description`+i+`[]" class="form-control"></td>
                                <td style="padding:10px"><input placeholder="Enter quantity" type="text" name="qty`+i+`[]"  class="form-control qty"></td>
                                <td style="padding:10px"><input type="text"  data-myAttri="`+i+`" placeholder="Enter unit price" name="unit`+i+`[]" class="form-control unit"></td>
                                <td style="padding:10px"><input type="text" readonly name="subtotal`+i+`[]" class="form-control value pkg-subtotal"></td>
                                <td>
                                <button type="button"  name="remove`+i+`[]"  data-myAttri="`+i+`" class="remove btn btn-danger" data-remove="`+i+`">X</button>
                                </td>
                            </tr>`;
            ...
            function addremoveClass() {
                $('.remove').click(function(){
                    ...
                    if( totalRowCount == 1) { 
                        $(this).closest("div #boxContainer"+boxNo).remove();
                    }
    ...
    function getval(event)
    {
        ...
        $('#loader').removeClass('d-none');
        const url = "{{route('getUnitValue')}}?id=" + dataid+"&boxNo="+boxNo;
        console.log(url);
        $.ajax({
            url: url,
            type: "GET",
            ...
            success: function (result) {
                ...
                $('#loader').addClass('d-none'); 
                $("input[name='unit_value"+result.boxno+"']").val(result.value);
