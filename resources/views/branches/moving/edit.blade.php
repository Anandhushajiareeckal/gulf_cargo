...
<i class="fa fa-save my-save"></i>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{update_url($moving->id)}}" id="editMoving" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Moving No.</label>
                                                <input type="text" value="{{$moving->moving_number}}" name="moving_number" class="form-control"
                                                       required readonly >
                                                @error('moving_number')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus name="branch_id" id="branch_id"
                                                    ...
                                                    @foreach ($branches as $branch)
                                                        <option
                                                            {{ ($moving->branch_id==$branch->id) ? 'selected' : "" }} value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                                ...
                                                <div class="form-group col-md-10">
                                                    ...
                                                    <option value='' selected="selected">Select </option>
                                                        @foreach (get_customers('sender') as $sender)
                                                            <option         {{ ($moving->sender_id== $sender->id) ? 'selected' : "" }} 
                                                                 value="{{ $sender->id }}"  data-phone="{{$sender->phone??""}}"
                                            ...
                                            <div class="row form-group col-md-12">
                                                ...
                                                <input readonly type="text"  value="{{$moving->sender->address->address??""}}" id="sender_address" class="form-control">
                                            </div> 

                                            <div class="row form-group col-md-12">
                                                <label>Phone</label>
                                                <input readonly type="text" value="{{$moving->sender->phone??""}}"  id="sender_phone" class="form-control">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="source_city" class="form-control"> 
                                                        ...
                                                        <option     {{ ($moving->source_city== $city->id) ? 'selected' : "" }}   value="{{ $city->id }}">{{ $city->name }}</option>
                                                        @endforeach 
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="destination_city" class="form-control"> 
                                                        @foreach ($cities_in_uae as $city)
                                                        <option   {{ ($moving->destination_city== $city->id) ? 'selected' : "" }}    value="{{ $city->id }}">{{ $city->name }}</option>
                                                        @endforeach 
                                                    </select>
                                        ...
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="moving_type" class="form-control">
                                                        ...
                                                        <option    {{   ($moving->moving_type==$movingType->id ) ? 'selected' : "" }}  value="{{ $movingType->id }}">{{ $movingType->name }}</option>
                                                        @endforeach 
                                                    </select>
...
<!--                                                 
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="agency_id" class="form-control"> 
                                                                ...
                                                                <option
                                                                    {{   ($moving->agency_id==$agency->id ) ? 'selected' : "" }} value="{{ $agency->id }}">{{ $agency->name }}</option>
                                                                @endforeach 
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="payment_method" class="form-control" id="">
                                                                <option
                                                                    {{ ( $moving->payment_method == 'cash_payment') ? 'selected' : "" }} value="cash_payment">
                                                                    Cash Payment
                                                                </option> 
                                                                <option
                                                                    {{ ( $moving->payment_method == 'credit') ? 'selected' : "" }} value="credit">
                                                                    Credit
                                                                </option>                                                              
                                                                <option
                                                                    {{ ( $moving->payment_method == 'bank') ? 'selected' : "" }} value="bank">
                                                                    Bank
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <option value="">--- Select Status ---</option>
                                                                @foreach (\App\Models\MovingStatuses::where('status',1)->get() as $item)
                                                                    <option
                                                                        {{ $moving->status_id == $item->id  ? 'selected' : "" }} value="{{ $item->id }}">{{ $item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('status_id')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="collected_by" id="collected_by" required>
                                                                <option value>Select</option>                                                        
                                                                    <option  {{ ($moving->collected_by == "driver" ) ? 'selected' : "" }} value="driver">Driver</option>
                                                                    <option  {{ ($moving->collected_by == "staff" ) ? 'selected' : "" }} value="staff">Office</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3" id="driver_or_staff">
                                                        <div class="form-group">
                                                        @if($moving->collected_by == "driver")
                                                            <label>Driver Name</label>
                                                            <select class="form-control" name="driver_id">
                                                                <option value>Selct Driver</option>
                                                                @foreach($drivers as $driver)
                                                                    <option  {{ ($moving->driver_id == $driver->id ) ? 'selected' : "" }} value="{{$driver->id}}">{{$driver->name}}</option>
                                                                @endforeach
                                                            </select>
                                                            @else 
                                                            <label>Staff Name</label>
                                                                <select class="form-control" name="staff_id">
                                                                    ...
                                                                    @foreach($staffs as $staff)
                                                                        <option  {{ ($moving->staff_id == $staff->id ) ? 'selected' : "" }} value="{{$staff->id}}">{{$staff->full_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                                @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="time" value="{{!empty($moving)?$moving->time:'' }}" class="timepicker form-control"
                                                ...
                                                <div class="col-md-3" id="confirmed_date">
                                                        <div class="form-group"> 
                                                        <label>Confirmed Date</label>
                                                                <input type="date" value="{{ isset($moving->confirmed_date) ? date('Y-m-d', strtotime($moving->confirmed_date)) : date('Y-m-d')}}" max=""
                                                    ...
                                                    <!-- <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="delivery_type" id="delivery_type" required>
                                                                <option value>Select</option>                                                        
                                                                    <option  {{ ($moving->delivery_type == 'door_to_door' ) ? 'selected' : "" }} value="door_to_door">Door To Door</option>
                                                                    <option  {{ ($moving->delivery_type ==  'door_to_port' ) ? 'selected' : "" }} value="door_to_port">Door To Port</option>
                                            ...
                                            <div class="body" id="dismantlinginfo"> 
                                                ...
                                                @foreach($dis_items as $dis_item)
                                                    ...
                                                    <td width="2%">
                                                        ...
                                                        <td width="40%">
                                                            <input type="text" placeholder="Enter description"
                                                                name="dis_description[]" value="{{ $dis_item->description }}"
                                                                class="form-control">
                                                        </td>
                                                        <td>
                                                            <input type="text" placeholder="Enter quantity"
                                                                name="dis_qty[]" value="{{ $dis_item->qty }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">                                                    
                                                            <input type="text" placeholder="Total Amount"
                                                                        name="total_amount" value="{{$moving->total_amount}}"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">                                                    
                                                            <input type="text" placeholder="Total Discount"
                                                                        name="total_discount"  value="{{$moving->total_discount}}"
...
$(function () {  
    ...
    document.getElementById("editMoving").onkeypress = function(e) {
    ...
    var moving_status = <?=$moving->status_id?>; 
    if( moving_status == 2 ){
