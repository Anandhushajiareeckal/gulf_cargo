                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="page-title-box"> 
                            ...
                            <form action="{{ update_url($sale->id) }}" method="post" enctype="multipart/form-data">
                                @csrf 
                                @method('PUT')
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" max=""
                                                    class="form-control" id="sale_date" value="{{date('Y-m-d', strtotime($sale->sale_date))}}" name="sale_date"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sale_number" value="{{$sale->sale_number}}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="branch_id" required>
                                                @foreach($branches as $branch)
                                                    <option value="{{$branch->id}}" @if($branch->id == $sale->branch_id) selected @endif>{{$branch->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="package col-md-12"  id="package_ID" >
                                            ...
                                            <div class="body" id="packageinfo">
                                                <table class="table table-bordered packageinfo">
                                                    ...
                                                    @foreach($saleProducts as $i => $saleProduct)
                                                    <?php  
                                                        $j = $i+1;
                                                    ?>
                                                    <tr count="{{$i+1}}">
                                                        ...
                                                        <td width="40%">
                                                            <select name="product_name[]" id="product_name{{$i+1}}" class="form-control product_name"  data-myattri="{{$i+1}}">
                                                                ...
                                                                @foreach($products as $product)
                                                                    <option value="{{$product->id}}" @if($product->id == $saleProduct->product_id) selected @endif data-price="{{$product->unit_rate}}">{{$product->product_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td> 
                                                            <input type="text" placeholder="Enter quantity" name="qty[]" id="product_qty{{$i+1}}" value="{{$saleProduct->quantity}}" price="{{$saleProduct->amount}}" class="form-control product_qty" data-myattri="{{$i+1}}"> 
                                                        </td>
                                                        <td>
                                                            <input type="text" placeholder="Enter unit price" name="unit[]" id="unit_price{{$i+1}}" value="{{$saleProduct->amount}}" readonly class="form-control unit_price" data-myattri="{{$i+1}}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="subtotal[]" id="subtotal{{$i+1}}" value="{{$saleProduct->amount * $saleProduct->quantity}}" readonly class="form-control value sub_total" data-myattri="{{$i+1}}">
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="body">
                                                <table class="table table-bordered">
                                                    <tr> 
                                                        ...
                                                        <td width="20%"><h6><span id="totalqty">{{$sale->total_quantity }}</span></h6></td>
                                                        <td width="20%" class="total"><h6>Total Amount : </h6></td>
                                                        <td width="20%"><h6><span id="totalAmt" class="package-total-amount totalAmt">{{$sale->total_amount }}</span></h6></td>                                                           
                                                    </tr>
                                                </table>
